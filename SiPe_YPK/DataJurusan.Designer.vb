...
Partial Class DataJurusan
    ...
    Private Sub InitializeComponent()
        ...
        Label1 = New Label()
        Label2 = New Label()
        DataGridJurusan = New DataGridView()
